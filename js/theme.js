              ...
              const data = {
               email: $('#subscribe_email').val()
                ...
                if (!e.isDefaultPrevented()) {
                    var url = "https://node.hostingladz.com:11111/v1/user/subscribe-click-assist";
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            if (messageAlert && messageText) {
                                ...
                                $('.subscribe-form').find('.subscribe_messages').html(alertBox);
                                // empty the form
        ...
        if($("#contact-form").length) {
            ...
            $('#contact-form').on('submit', function (e) {
              ...
              const data = {
                ...
                // if the validator does not prevent form submit
                if (!e.isDefaultPrevented()) {
                    var url = "https://node.hostingladz.com:11111/v1/user/contact-click-assist";
